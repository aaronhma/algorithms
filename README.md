...
|     | [Kruskal](algorithms/graphs/spanning-trees/kruskal-algorithm/README.md)                                       | [C++](algorithms/graphs/spanning-trees/kruskal-algorithm/kruskal.cpp)                                                                                                                                                      |        | [cp-algo](https://cp-algorithms.web.app/graph/mst_kruskal.html), [Techie Delight](https://www.techiedelight.com/kruskals-algorithm-for-finding-minimum-spanning-tree/)                                                                   |
...
|     | [Prim](algorithms/graphs/spanning-trees/prim-algorithm/README.md)                                             | [C++](algorithms/graphs/spanning-trees/prim-algorithm/prim.cpp)                                                                                                                                                            |        | [cp-algo](https://cp-algorithms.web.app/graph/mst_prim.html)                                                                                                                                                                             |
...
| --- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- | ------ | ----------------------------------------------------------------------------- |
|     | [Longest Increasing Subsequence](algorithms/strings/problems/longest-increasing-subsequence/README.md) | [C++](algorithms/strings/problems/longest-increasing-subsequence/longest-increasing-subsequence.cpp) |        | [Tech Delight](https://www.techiedelight.com/longest-increasing-subsequence/) |
...
|     | [Sqrt Decomposition](data-structure/non-linear/sqrt-decomposition/README.md) | [C++](data-structure/non-linear/sqrt-decomposition/sqrt-decomposition.cpp), [Mo's Algorithm](data-structure/non-linear/sqrt-decomposition/mo-algorithm.cpp) |        |                                                                                                                                                                                 |
...
|     | [Fenwick Tree](data-structure/trees/fenwick-tree/README.md)                       | [C++](data-structure/trees/fenwick-tree/fenwick-tree.cpp)     |        | [cp-algo](https://cp-algorithms.com/data_structures/fenwick.html)                |
